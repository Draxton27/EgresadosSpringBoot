...
COPY target/egresados-0.0.1-SNAPSHOT.jar /app/egresados-0.0.1-SNAPSHOT.jar

# Copy the initialization SQL script and entrypoint script
COPY ddl-scripts/setup.sql /app/setup.sql
COPY ddl-scripts/entrypoint.sh /app/entrypoint.sh
